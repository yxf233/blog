	...
	<div class="panel-body">
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article): $mod = ($i % 2 );++$i;?><div class="media">
				<div class="media-left">
					<a href="<?php echo U('/index/article',array('id'=>$article['articleId']));?>">
				...
				<div class="media-body">
					...
					<div class="text-muted">
						...
						<i class="glyphicon glyphicon-list"></i> <a class="text-muted" href="<?php echo U('/index/category',array('id'=>$article['categoryId']));?>"><?php echo ($article["name"]); ?></a>
					</div>
