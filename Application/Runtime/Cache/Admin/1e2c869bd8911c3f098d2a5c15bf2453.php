...
<div class="container">
	<h1>友情链接</h1>
	<p>
		<a href="<?php echo U('admin/link/add');?>" class="btn btn-primary">添加</a>
	</p>
	<div class="table-responsive">
		<table class="table table-bordered">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a href="<?php echo U('admin/link/edit?id='.$item['linkId']);?>">编辑</a>
						<a href="<?php echo U('admin/link/delete?id='.$item['linkId']);?>" onclick="return confirm('确定删除吗?')">删除</a>
					</td>
