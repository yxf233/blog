...
<head>
	...
	<link rel="stylesheet" href="/blog/public/admin/css/login.css">
	<!--[if lt IE 9]>
...
<body>
<div class="jumbotron">
	<h1 class="text-center">yxf管理系统</h1>
</div>
<div class="content">
	<form action="/blog/admin/index/login.html" class='form-inline text-center' method="post">
