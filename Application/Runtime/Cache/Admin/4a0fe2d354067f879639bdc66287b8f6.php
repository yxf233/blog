...
<link rel="stylesheet" href="/blog/public/vendor/umeditor/themes/default/css/umeditor.min.css">
<div class="container">
	<?php if(empty($data)): ?><h1>发表文章</h1>
		<?php else: ?>
		<h1>编辑文章</h1><?php endif; ?>
	<form action="/blog/admin/article/add.html" method="post" class="form-horizontal" id="form">
...
<script>
	$('#file').on('change', function(e) {
		if (e.target.files.length > 0) {
			...
			xhr.open('POST', '<?php echo U("admin/index/upload");?>', true);
			var fd = new FormData;
			fd.append("file", file);
...
<script src="/blog/public/vendor/umeditor/umeditor.config.js"></script>
<script src="/blog/public/vendor/umeditor/umeditor.min.js"></script>
<script>
