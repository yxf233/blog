...
<div class="container">
	<h1>文章分类</h1>
	<p>
		<a href="<?php echo U('admin/category/add');?>" class="btn btn-primary">添加分类</a>
	</p>
		...
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="<?php echo U('admin/category/edit?id='.$item['categoryId']);?>">编辑</a>
							<a href="<?php echo U('admin/category/delete?id='.$item['categoryId']);?>" onclick="return confirm('确定删除吗？')">删除</a>
						</td>
