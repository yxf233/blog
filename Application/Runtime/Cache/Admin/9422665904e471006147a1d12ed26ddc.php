		...
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a href="<?php echo U('/index/article',array('id'=>$item['articleId']));?>" target="_blank">查看</a>
						</td>
						<td>
							<a href="<?php echo U('admin/comment/delete',array('id'=>$item['commentId']));?>" onclick="return confirm('确定删除吗')">删除</a>
						</td>
